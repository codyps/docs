...
sourcesIndex['cstr_argument'] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex['libsystemd_sys'] = {"name":"","dirs":[{"name":"bus","dirs":[],"files":["mod.rs","vtable.rs"]}],"files":["daemon.rs","event.rs","id128.rs","journal.rs","lib.rs","login.rs"]};
